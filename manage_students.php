...
<body id="login">
<div class=""><h1 class="lgn_2_txt">Manage students details</h1></div>
<div class="row fr">
    <div class="col-md-2 ">
...
<tr>
    ...
    <td><button><a href='update.php? y= $id' ><img class='ico' src='Resources/update.png' alt=''></a></button></td>
    <td><a href='delete.php? x= $id'><img class='ico' src='Resources/del.png' alt=''></a></td>
    ";
            }
            ?>
        </table>
